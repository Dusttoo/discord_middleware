const DiscordBotIntegration = DiscordBotIntegration || {};
DiscordBotIntegration.templates = {};

DiscordBotIntegration.templates.renderCharacterStats = async function(actor) {
...
DiscordBotIntegration.templates.renderInventory = async function(actor) {
...
DiscordBotIntegration.templates.renderSpellDetails = async function(actor, spellId) {
...
DiscordBotIntegration.templates.renderTurnNotification = async function(actor) {
